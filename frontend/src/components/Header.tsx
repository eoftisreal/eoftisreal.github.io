        ...
        />
          ...
          <nav className="flex items-center justify-end gap-4 md:gap-6 flex-1">
            ...
            <Link to="/cart" className={`${linkClass} flex items-center relative`} title="Cart">
              ...
              {cartItemCount > 0 && (
                <span className="absolute top-0.5 right-0.9 bg-foreground text-white text-[10px] font-bold h-4 min-w-[16px] flex items-center justify-center rounded-full px-1">
                  {cartItemCount}
                </span>
              )}
            </Link>
